...
export class Effect {
   ...
   * @param {number} numberC - x value
   * @param {number} numberD - y value
   * @param {object} simplex - simplex noise instance
   * @param {boolean} noise - true or false
   * @param {number} noiseX - x value
   * @param {number} noiseY - y value
   ...
   * @param {number} numberC - x value
   * @param {number} numberD - y value
   * @param {scaleOne} scaleOne - scale value
   * @param {object} simplex - simplex noise instance
   * @param {boolean} noise - true or false
   * @param {number} noiseX - x value
   * @param {number} noiseY - y value
